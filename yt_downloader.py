...
------------------------''')
    ...
    try:
        if os.name in ('nt', 'dos'):
            try:
                os.mkdir(f'D:\YT-Downloader\{pl_name}')
                file = f'D:\YT-Downloader\{pl_name}'
            except:
                file = 'D:\YT-Downloader'
        else:
            try:  
                os.mkdir(f'/sdcard/Download/YT-Downloader/{pl_name}')
                file = f'/sdcard/Download/YT-Downloader/{pl_name}'
